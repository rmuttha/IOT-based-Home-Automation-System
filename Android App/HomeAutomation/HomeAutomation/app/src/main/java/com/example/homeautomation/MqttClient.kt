 ...
 *
 * @brief   File for the functions to handle various MQTT operations like connect, disconnect, etc
 *
 ******************************************************************************/
...
class MqttClient(context: Context?,
                 serverURI: String,
                 clientID: String = "") {
    // Create an instance of the MqttAndroidClient class.
    // This will be used to communicate with the MQTT broker.
    ...
    private val defaultCbClient = object : MqttCallback {
        ...
        // Callback for subscribe success/failure.
        override fun deliveryComplete(token: IMqttDeliveryToken?) {
            Log.d(this.javaClass.name, "Delivery completed")
        }
    }
    // Define default callbacks for various events.

    // Callback for connection success/failure.
    ...
    // Callback for unsubscribe success/failure.
    ...
    // Callback for disconnect success/failure.
